...
public class Etape implements Serializable {
    ...
    @OneToMany(mappedBy = "etapes")
    @JsonIgnoreProperties(value = { "recettes", "etapes", "ingredients" }, allowSetters = true)
    ...
    public void setRecettes(Set<Recette> recettes) {
        if (this.recettes != null) {
            this.recettes.forEach(i -> i.setEtapes(null));
        }
        if (recettes != null) {
            recettes.forEach(i -> i.setEtapes(this));
        }
