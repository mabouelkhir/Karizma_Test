            ...
            <tbody>
              {recetteList.map((recette, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{recette.recettes ? recette.recettes.id : ''}</td>
                  <td>{recette.etapes ? <Link to={`/etape/${recette.etapes.id}`}>{recette.etapes.id}</Link> : ''}</td>
                  <td>{recette.ingredients ? <Link to={`/ingredient/${recette.ingredients.id}`}>{recette.ingredients.id}</Link> : ''}</td>
